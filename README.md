...
- 视觉与交互基线：`V4.2.13+`（多页面统一样式、反馈/联系/路线详情重构、404 美化）
...
- 多页面样式统一：首页风格映射到 about/events/routes/contact/feedback/404 等页面
- 路线详情页重构：双列紧凑布局、全屏地图、固定高德底图选项、反馈入口跳转
- 反馈页重构：来源路由可视化、表单结构优化、信息层级与引导增强
- 联系页重构：双栏信息布局、官方邮箱操作区、复制邮箱交互
- 404 页面美化：统一站点视觉并提供快速回退入口
- 主题切换方式调整：
  - 取消悬浮选择器
  - 使用导航“主题”按钮在当前页展开主题面板并即时切换
- 管理团队页临时下线：入口隐藏，`/team` 当前返回 404（待组织信息确认后恢复）
