(function () {
  ...
  function applySingleCoverVar(name,cover){var root=document.documentElement;if(!cover){root.style.setProperty(name,'none');return;}var img=new Image();img.onload=function(){root.style.setProperty(name,"url('"+cover+"')");};img.onerror=function(){root.style.setProperty(name,'none');};img.src=cover;}
